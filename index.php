...
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <meta name="description" content="Claudia Belforte">
    <meta name="keywords" content="estudio,contable,contador,contadora,contabilidad">
...
<body>
    <header id="header">
        ...
        <nav class="menu">
            <div class="logo-box">
                <a href="#"><img src="img/logoeste.png" class="logo-nav" alt=""></a>
        ...
        <div class="img-header">
            <div class="inicio">
                <p>BELFORTE CLAUDIA VALERIA</p>
                <hr>
                <h1>FRONT-END DEVELOPER</h1>
                <button id="abajo">Ver más</button>
            </div>
        </div>
        ...
        <div class="ejeZproject">
            <div class="container-project">
                ...
                <div class="project-img">
                    <img src="img/rompiendocodigos.png" alt="">
                    <img src="img/trueley.png" alt="">
                    <img src="img/navarro-insaurralde.png" alt="">
                    <img src="img/diariodigital.png" alt="">
                </div>
            </div>
        </div>
        <div class="skew-abajo"></div>
        ...
        <div class="ejeZfooter">
            <div class="footer-content">
                        ...
                        if(isset($nombre))
                         {
                            if(isset($email))
                            {
                                if(isset($mensaje)) {
                                    ...
                                    $asunto = "portfolio";
                                    $cuerpo = $nombre."\n".$email."\n".$mensaje;
                                    $adicional = "From : claubelforte@outlook.com";
                ...
                <div class="footer-text">
                   <p>&copy;Derechos reservados 2020 |  Hecho con <i class="far fa-heart"></i> por Claudia Belforte.  </p>
                </div>
            </div>
        </div>
    </footer>
